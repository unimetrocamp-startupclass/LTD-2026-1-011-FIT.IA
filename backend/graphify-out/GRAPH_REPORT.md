...
## Corpus Check
- 43 files · ~62,858 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 110 nodes · 257 edges · 8 communities detected
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7c79202`
...
Cohesion: 0.14
Nodes (6): CreateWorkoutPlan, GetWorkoutDay, GetWorkoutPlan, GetWorkoutPlans, ListWorkoutPlans, UpdateWorkoutSession

### Community 2 - "Community 2"
Cohesion: 0.19
Nodes (9): Start Workout Session API Requirement, WorkoutPlanNotActiveError, WorkoutSessionAlreadyCompletedError, WorkoutSessionAlreadyStartedError, workoutPlanRoutes(), Start Workout Session Route Task, Update Workout Session Route Task, Weekly Consistency in UTC (+1 more)
...
- **Why does `GetStats` connect `Community 6` to `Community 0`, `Community 5`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `NotFoundError` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`?**
